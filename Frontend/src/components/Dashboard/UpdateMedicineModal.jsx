...
const UpdateMedicineModal = ({ isOpen, onClose, medicine, onMedicineUpdated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Update form data:', Object.fromEntries(formDataToSend));
      const response = await updateMedicine(medicine._id, formDataToSend);
      console.log('Medicine updated successfully:', response);
      
      if (onMedicineUpdated) {
        onMedicineUpdated(response);
      }
      onClose();
    } catch (err) {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-xl">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-gray-900">Update Medicine</h2>
            <button
              onClick={onClose}
